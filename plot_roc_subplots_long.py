...
for radius in [400,800,1200,1600,2000,3000,5000,7500,10000]:#[200,500,800,1000,2000,3500,5000,7500,10000]:#[200,300,400]:#np.append(np.linspace(100,10000,37),np.array([1,10,100,500,1000,5000,10000,15000])):
    ...
    s1_TPR_int05 = []
    s1_FPR_int05 = []
    for percent in np.linspace(100,0,3):
...
plt.scatter(rhodot_FPR_all_int05[0][::20],rhodot_TPR_all_int05[0][::20],color='g',label='{0:1.3f}'.format(
#        simps([y/rhodot_TPR_all_int05[0][-1] for y in rhodot_TPR_all_int05[0]],[x/rhodot_FPR_all_int05[0][-1] for x in rhodot_FPR_all_int05[0]])))
        simps(rhodot_TPR_all_int05[0],[x/rhodot_FPR_all_int05[0][-1] for x in rhodot_FPR_all_int05[0]])))
plt.plot(rhodot_FPR_all_int1[0],rhodot_TPR_all_int1[0],'r-')
plt.scatter(rhodot_FPR_all_int1[0][::20],rhodot_TPR_all_int1[0][::20],color='r',label='{0:1.3f}'.format(simps(rhodot_TPR_all_int1[0],[x/rhodot_FPR_all_int1[0][-1] for x in rhodot_FPR_all_int1[0]])))
plt.plot(rhodot_FPR_all_int2[0],rhodot_TPR_all_int2[0],'b-.')
plt.scatter(rhodot_FPR_all_int2[0][::20],rhodot_TPR_all_int2[0][::20],color='b',label='{0:1.3f}'.format(simps(rhodot_TPR_all_int2[0],[x/rhodot_FPR_all_int2[0][-1] for x in rhodot_FPR_all_int1[0]])))
plt.annotate('0.4km', xy=(0.16, 0.82), xycoords='axes fraction')
plt.xlim([-0.1,1.1])
plt.ylim([-0.1,1.1])
plt.yticks(**tickfont)
plt.xticks()
...
plt.scatter(rhodot_FPR_all_int05[P][::20],rhodot_TPR_all_int05[P][::20],color='g',label='{0:1.3f}'.format(simps([y/rhodot_TPR_all_int05[P][-1] for y in rhodot_TPR_all_int05[P]],[x/rhodot_FPR_all_int05[P][-1] for x in rhodot_FPR_all_int05[P]])))
plt.plot(rhodot_FPR_all_int1[P],rhodot_TPR_all_int1[P],'r-')
plt.scatter(rhodot_FPR_all_int1[P][::20],rhodot_TPR_all_int1[P][::20],color='r',label='{0:1.3f}'.format(simps([y/rhodot_TPR_all_int1[P][-1] for y in rhodot_TPR_all_int1[P]],[x/rhodot_FPR_all_int1[P][-1] for x in rhodot_FPR_all_int1[P]])))
plt.plot(rhodot_FPR_all_int2[P],rhodot_TPR_all_int2[P],'b-.')
plt.scatter(rhodot_FPR_all_int2[P][::20],rhodot_TPR_all_int2[P][::20],color='b',label='{0:1.3f}'.format(
...
plt.scatter(s1_FPR_all_int05[P][::20],s1_TPR_all_int05[P][::20],color='g')
plt.plot(s1_FPR_all_int1[P],s1_TPR_all_int1[P],'r-')
plt.scatter(s1_FPR_all_int1[P][::20],s1_TPR_all_int1[P][::20],color='r')
plt.plot(s1_FPR_all_int2[P],s1_TPR_all_int2[P],'b-.')
plt.scatter(s1_FPR_all_int2[P][::20],s1_TPR_all_int2[P][::20],color='b')
plt.annotate('10.0km', xy=(0.70, 0.02), xycoords='axes fraction')
plt.xlim([-0.1,1.1])
plt.ylim([-0.1,1.1])
plt.yticks([])
