...
ax3=plt.plot(tw,rhodot,color='k',label="$\\dot{\\rho}$")
ax2=plt.plot(tw,p2rhodot,color='b',label="2km circle")
ax1=plt.plot(tw,h2rhodot,color='r',label="2km flight")
...
ax3=plt.plot(tw,rhodot,color='k',label="$\\dot{\\rho}$")
ax2=plt.plot(tw,p5rhodot,color='b',label="5km circle")
ax1=plt.plot(tw,h5rhodot,color='r',label="5km flight")
plt.tick_params(labelbottom='off')
...
ax3=plt.plot(tw,rhodot,color='k',label="$\\dot{\\rho}$")
ax2=plt.plot(tw,p10rhodot,color='b',label="10km circle")
ax1=plt.plot(tw,h10rhodot,color='r',label="10km flight")
plt.ylabel('hr$^{-1}$',**labelfont)
plt.legend(prop = font)
plt.autoscale(enable=True, axis='x', tight=True)
plt.yticks(**tickfont)
...
ax3=plt.plot(tw,rhodot,color='k',label="$\\dot{\\rho}$")
ax2=plt.plot(tw,p15rhodot,color='b',label="15km circle")
ax1=plt.plot(tw,h15rhodot,color='r',label="15km flight")
plt.tick_params(labelleft='off')
plt.legend(prop = font)
plt.autoscale(enable=True, axis='x', tight=True)
plt.yticks([])#**tickfont)
...
gs1.update(wspace=0.05, hspace=0.05)
sub1 = plt.subplot(gs1[0])
ax3=plt.plot(tw,s1,color='k',label="s$_{1}$")
ax2=plt.plot(tw,p2s1,color='b',label="2km circle")
ax1=plt.plot(tw,h2s1,color='r',label="2km flight")
plt.tick_params(labelbottom='off')
plt.ylabel('hr$^{-1}$',**labelfont)
plt.legend(prop = font)
plt.autoscale(enable=True, axis='x', tight=True)
...
sub2 = plt.subplot(gs1[1])
ax3=plt.plot(tw,s1,color='k',label="s$_{1}$")
ax2=plt.plot(tw,p5s1,color='b',label="5km circle")
ax1=plt.plot(tw,h5s1,color='r',label="5km flight")
plt.tick_params(labelbottom='off')
plt.tick_params(labelleft='off')
plt.legend(prop = font)
plt.autoscale(enable=True, axis='x', tight=True)
...
sub3 = plt.subplot(gs1[2])
ax3=plt.plot(tw,s1,color='k',label="s$_{1}$")
ax2=plt.plot(tw,p10s1,color='b',label="10km circle")
ax1=plt.plot(tw,h10s1,color='r',label="10km flight")
plt.ylabel('hr$^{-1}$',**labelfont)
plt.legend(prop = font)
plt.autoscale(enable=True, axis='x', tight=True)
plt.yticks(**tickfont)
...
sub4 = plt.subplot(gs1[3])
ax3=plt.plot(tw,s1,color='k',label="s$_{1}$")
ax2=plt.plot(tw,p15s1,color='b',label="15km circle")
ax1=plt.plot(tw,h15s1,color='r',label="15km flight")
...
axf05=plt.plot(tw,-ftle05,color='g',label="0.5hr $\\sigma$")
axf1=plt.plot(tw,-ftle1,color='b',label="1hr $\\sigma$")
axf4=plt.plot(tw,-ftle2,color='c',label="2hr $\\sigma$")
plt.autoscale(enable=True, axis='x', tight=True)
plt.legend(prop = font)
plt.yticks(**tickfont)
plt.xticks(**tickfont)
