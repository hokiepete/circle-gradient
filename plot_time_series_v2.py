...
ax3=plt.plot(tw,rhodot,color='C3',label="$\\dot{\\rho}$")
ax2=plt.plot(tw,p2rhodot,color='k',label="2km circle")
ax1=plt.plot(tw,h2rhodot,color='C0',label="2km flight")
...
ax3=plt.plot(tw,rhodot,color='C3',label="$\\dot{\\rho}$")
ax2=plt.plot(tw,p5rhodot,color='k',label="circle")
ax1=plt.plot(tw,h5rhodot,color='C0',label="flight")
plt.tick_params(labelbottom='off')
...
ax3=plt.plot(tw,rhodot,color='C3',label="$\\dot{\\rho}$")
ax2=plt.plot(tw,p10rhodot,color='k',label="10km circle")
ax1=plt.plot(tw,h10rhodot,color='C0',label="10km flight")
plt.ylabel('hr$^{-1}$',**labelfont)
plt.autoscale(enable=True, axis='x', tight=True)
plt.yticks(**tickfont)
plt.xticks(**tickfont)
...
ax3=plt.plot(tw,rhodot,color='C3',label="$\\dot{\\rho}$")
ax2=plt.plot(tw,p15rhodot,color='k',label="15km circle")
ax1=plt.plot(tw,h15rhodot,color='C0',label="15km flight")
plt.tick_params(labelleft='off')
plt.autoscale(enable=True, axis='x', tight=True)
plt.yticks([])#**tickfont)
plt.xticks(**tickfont)
...
gs1.update(wspace=0.05, hspace=0.05)
sub1 = plt.subplot(gs1[0])
ax3=plt.plot(tw,s1,color='C3',label="s$_{1}$")
ax2=plt.plot(tw,p2s1,color='k',label="2km circle")
ax1=plt.plot(tw,h2s1,color='C0',label="2km flight")
plt.tick_params(labelbottom='off')
plt.ylabel('hr$^{-1}$',**labelfont)
plt.autoscale(enable=True, axis='x', tight=True)
plt.yticks(**tickfont)
...
sub2 = plt.subplot(gs1[1])
ax3=plt.plot(tw,s1,color='C3',label="s$_{1}$")
ax2=plt.plot(tw,p5s1,color='k',label="circle")
ax1=plt.plot(tw,h5s1,color='C0',label="flight")
plt.tick_params(labelbottom='off')
plt.tick_params(labelleft='off')
plt.autoscale(enable=True, axis='x', tight=True)
plt.yticks([])#**tickfont)
...
sub3 = plt.subplot(gs1[2])
ax3=plt.plot(tw,s1,color='C3',label="s$_{1}$")
ax2=plt.plot(tw,p10s1,color='k',label="10km circle")
ax1=plt.plot(tw,h10s1,color='C0',label="10km flight")
plt.ylabel('hr$^{-1}$',**labelfont)
plt.autoscale(enable=True, axis='x', tight=True)
plt.yticks(**tickfont)
plt.xticks(**tickfont)
...
sub4 = plt.subplot(gs1[3])
ax3=plt.plot(tw,s1,color='C3',label="s$_{1}$")
ax2=plt.plot(tw,p15s1,color='k',label="15km circle")
ax1=plt.plot(tw,h15s1,color='C0',label="15km flight")
